...
//         {/* Hero Section */}
//         <section className="bg-linear-to-r from-blue-900 to-blue-600 text-white px-6 md:px-12 py-12 md:py-20 flex flex-col md:flex-row items-center justify-between gap-10">
//           {/* Left */}
...
//             {/* Search */}
//             <div className="bg-white rounded-lg flex flex-col md:flex-row items-stretch overflow-hidden w-full md:w-140 mx-auto md:mx-0">
//               <input
//                 type="text"
//                 placeholder="Job Title or Keyword"
//                 className="flex-1 px-4 py-3 text-black outline-none border-b md:border-b-0"
//               />

//               <input
//                 type="text"
//                 placeholder="Location"
//                 className="flex-1 px-4 py-3 text-black outline-none md:border-l"
//               />
...
//         {/* Categories */}
//         <section className="bg-gray-100 px-6 md:px-12 py-10">
//           <h3 className="text-lg md:text-xl font-semibold mb-6">
//             Job Categories
//           </h3>

//           <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 md:gap-6">
//             {["Marketing", "Design", "Development", "Finance", "More"].map((item, i) => (
//               <div
//                 key={i}
//                 className="bg-white py-4 md:py-6 rounded-lg shadow text-center text-sm md:text-base cursor-pointer hover:shadow-md"
//               >
//                 {item}
//               </div>
//             ))}
